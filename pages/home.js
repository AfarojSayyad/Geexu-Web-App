      ...
      <div className="container-fluid bg-[#1A1A1A] h-[auto] px-6 md:px-16 lg:px-28 -mt-1">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-3 sm:gap-6 md:grid-cols-3 lg:grid-cols-3 2xl:gap-16 xl:gap-16 lg:gap-[3rem] md:gap-8">
            <div className="laravel 2xl:-mt-[3.95rem] xl:-mt-[4rem] lg:-mt-[4rem] md:-mt-8 -mt-14 h-auto mb-10 sm:mb-0">
              <div
              ...
              <div className=" mt-3.5 sm:mt-[0.875rem] md:mt-6 lg:mt-[1.313rem] xl:mt-10 2xl:mt-9">
                <p className="text-[#C0C0C1] 2xl:text-lg 2xl:leading-loose lg:text[1rem] lg:leading-[1.875rem] md:text-[0.975rem] md:leading-[1.688rem] sm:text-[0.875rem] sm:leading-[1.688rem] text-[1rem] leading-[1.875rem] font-[400] px-4  sm:w-[8.6rem] md:w-[10.5rem] lg:w-[13rem] xl:w-[20rem] xl: lg:m-auto 2xl:w-[25rem] 2xl:m-auto ">
                  Geexu provides advanced web application development services.
                  This service helps to design, build and evolve web based
                  software. To deliver the successful projects to you, we have
                  the experts in the field of web application.
                </p>
              </div>
            </div>

            <div className="vue-react 2xl:-mt-[3.95rem] xl:-mt-[4rem] lg:-mt-[4rem] md:-mt-8 sm:-mt-14 mt-2.5 h-auto mb-[3.1rem] sm:mb-10 md:mb-20">
              <div
                ...
                // "
                style={{
                  "background-image": "url('/secound-section/vue-react.jpg')",
                  "background-repeat": "no-repeat",
                  "background-size": "cover",
                }}
              >
                <div className="absolute top-0 left-0 flex items-end bg-gradient-to-t from-black to-transperent w-full h-full">
                  <h4 className="font-[signifier] text-white font-[300] absolute 2xl:bottom-[2.125rem] 2xl:left-9 xl:bottom-8 xl:left-9 lg:bottom-5 lg:left-6 md:bottom-5 md:left-6 bottom-5 left-6 2xl:text-[2.25rem] 2xl:leading-[2.5rem] xl:text-[2.25rem] xl:leading-[2.5rem] md:text-3xl sm:text-[1.875rem] sm:leading-[2.25rem] text-4xl">
                    Mobile <p></p>
                    application
                  </h4>
                </div>
              ...
              <div className=" mt-3.5 sm:mt-[0.875rem] md:mt-6 lg:mt-[1.313rem] xl:mt-10 2xl:mt-9">
                <p className="text-[#C0C0C1] 2xl:text-lg 2xl:leading-loose lg:text[1rem] lg:leading-[1.875rem] md:text-[0.975rem] md:leading-[1.688rem] sm:text-[0.875rem] sm:leading-[1.688rem] text-[1rem] leading-[1.875rem] font-[400] px-4  sm:w-[8.6rem] md:w-[10.5rem] lg:w-[13rem] xl:w-[20rem] xl: lg:m-auto 2xl:w-[25rem] 2xl:m-auto ">
                  ...
                  will help you create practical and efficient experiences on
                  any device, and allows you to get the most out of mobile
                  technology for your organization. We build mobile applications
                  on different platforms using top-notch technologies and proven
                  approaches
                </p>
              </div>
            </div>

            <div className="hybrid-mobile 2xl:-mt-[3.95rem] xl:-mt-[4rem] lg:-mt-[4rem] md:-mt-8 sm:-mt-14 h-auto">
              <div
                ...
                // "
                style={{
                  "background-image": "url('/secound-section/hybrid.jpg')",
                  "background-repeat": "no-repeat",
                  "background-size": "cover",
                }}
              >
              ...
              <div className=" mt-3.5 sm:mt-[0.875rem] md:mt-6 lg:mt-[1.313rem] xl:mt-10 2xl:mt-9">
                <p className="text-[#C0C0C1] 2xl:text-lg 2xl:leading-loose lg:text[1rem] lg:leading-[1.875rem] md:text-[0.975rem] md:leading-[1.688rem] sm:text-[0.875rem] sm:leading-[1.688rem] text-[1rem] leading-[1.875rem] font-[400] px-4  sm:w-[8.6rem] md:w-[10.5rem] lg:w-[13rem] xl:w-[20rem] xl: lg:m-auto 2xl:w-[25rem] 2xl:m-auto ">
                  Geexu specializes in offering top-notch services in the area
                  of web development. We work with important elements when
                  developing a website for our clients. We make sure that the
                  theme of the end
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto xl:mt-9 lg:mt-[4.25rem] md:mt-8 sm:mt-8 mt-[4.75rem]">
            ...
            {/* Products Row */}
            <div className="grid sm:grid-cols-3 grid-cols-2 grid-gap-4 mt-10 sm:mt-24 md:mt-16 lg:mt-20 xl:mt-[5.375rem] 2xl:mt-24">
              <div className="Product col-span-2 md:col-span-1 sm:col-span-1 lg:col-span-1">
                <h3 className="text-[#65b722] font-[Pitch Sans] font-bold 2xl:text-[1.25rem] 2xl:leading-[1.75rem] xl:text-[1rem] xl:leading-[1rem] lg:text-[1.125rem] lg:leading-[1.75rem] md:text-[1rem] md:[1.5rem] text-[0.875rem] leading-[1.25rem] sm:mb-0 mb-9 tracking-widest">
                  PRODUCTS
                </h3>
              </div>
              <div>
                <ul className="2xl:pl-10 xl:pl-10 lg:pl-14 md:pl-12 sm:-ml-10 2xl:pt-0 xl:pt-0 lg:pt-2">
                  <li className="text-[#e6e6e6] border-b border-[#2B2B2B] border-b-2 font-mono 2xl:text-[1.25rem] 2xl:leading-[1.563rem] text-[0.875rem] leading-[1.125rem] md:text-base lg:text-[1.125rem] lg:leading-[1.438rem] 2xl:w-[93%] xl:w-[90%] lg:w-[96%] md:w-[95%] sm:w-[85%] xl:ml-6 2xl:pb-4 xl:pb-4 lg:pb-4 md:pb-4 mb-3 pb-2">
                    Web Applications
                  </li>
                  <li className="text-[#e6e6e6] border-b border-[#2B2B2B] border-b-2 font-mono 2xl:text-[1.25rem] 2xl:leading-[1.563rem] text-[0.875rem] leading-[1.125rem] md:text-base lg:text-[1.125rem] lg:leading-[1.438rem] 2xl:w-[93%] xl:w-[90%] lg:w-[96%] md:w-[95%] sm:w-[85%] xl:ml-6 2xl:pb-4 xl:pb-4 lg:pb-4 md:pb-4 mb-3 pb-2">
                    Hybrid Mobile Apps
                  ...
                  <li className="text-[#e6e6e6] border-b border-[#2B2B2B] border-b-2 font-mono 2xl:text-[1.25rem] 2xl:leading-[1.563rem] text-[0.875rem] leading-[1.125rem] md:text-base lg:text-[1.125rem] lg:leading-[1.438rem] 2xl:w-[93%] xl:w-[90%] lg:w-[96%] md:w-[95%] sm:w-[85%] xl:ml-6 2xl:pb-4 xl:pb-4 lg:pb-4 md:pb-4 lg:mb-0 pb-2">
                    SaaS
                  </li>
                </ul>
              </div>
              <div>
                <ul className="2xl:ml-4 2xl:pl-5 xl:pl-10 lg:pl-6 lg:ml-0 md:ml-5 ml-4 2xl:pt-0 xl:pt-0 lg:pt-2">
                  <li className="text-[#e6e6e6] border-b border-[#2B2B2B] border-b-2 text-white font-mono 2xl:text-[1.25rem] 2xl:leading-[1.563rem] text-[0.875rem] leading-[1.125rem] md:text-base lg:text-[1.125rem] lg:leading-[1.438rem] md:w-[95%] lg:w-[100%] 2xl:w-full 2xl:pb-4 xl:pb-4 lg:pb-4 md:pb-4 mb-3 pb-2">
                    Code Audits
                  </li>
                  <li className="text-[#e6e6e6] border-b border-[#2B2B2B] border-b-2 text-white font-mono 2xl:text-[1.25rem] 2xl:leading-[1.563rem] text-[0.875rem] leading-[1.125rem] md:text-base lg:text-[1.125rem] lg:leading-[1.438rem] md:w-[95%] lg:w-[100%] 2xl:w-full 2xl:pb-4 xl:pb-4 lg:pb-4 md:pb-4 mb-3 pb-2">
                    Custom Packages
                  ...
                  <li className="text-[#e6e6e6] border-b border-[#2B2B2B] border-b-2 text-white font-mono 2xl:text-[1.25rem] 2xl:leading-[1.563rem] text-[0.875rem] leading-[1.125rem] md:text-base lg:text-[1.125rem] lg:leading-[1.438rem] md:w-[95%] lg:w-[100%] 2xl:w-full 2xl:pb-4 xl:pb-4 lg:pb-4 md:pb-4 lg:mb-0 pb-2">
                    Rescues
                  </li>
                </ul>
              </div>
            ...
            {/* Displines Row */}
            <div className="grid sm:grid-cols-3 grid-cols-2 grid-gap-4 mt-[3rem] lg:mt-20 xl:mt-[5.5rem] 2xl:mt-[5.7rem]">
              <div className="col-span-2 md:col-span-1 sm:col-span-1 lg:col-span-1">
                <h3 className="text-[#65b722] font-[Pitch Sans] font-bold word-spacing-tight 2xl:text-[1.25rem] 2xl:leading-[1.75rem] xl:text-[1rem] xl:leading-[1rem] lg:text-[1.125rem] lg:leading-[1.75rem] lg:text-lg md:text-[1rem] md:leading-[1.5rem] text-[0.875rem] leading-[1.25rem] sm:mb-0 mb-9 tracking-widest">
                  DISCPLINES
                </h3>
              </div>
              ...
              <div>
                <ul className="2xl:pl-5 xl:pl-6 xl:ml-0 lg:pl-0 md:ml-3 sm:-ml-10">
                  <li className="text-[#e6e6e6] border-b border-[#2B2B2B] border-b-2 font-mono 2xl:text-[1.25rem] 2xl:leading-[1.563rem] text-[0.875rem] leading-[1.125rem] md:text-base lg:text-[1.125rem] lg:leading-[1.438rem] 2xl:w-[96%] xl:w-[90%] lg:w-[96%] md:w-[95%] sm:w-[85%] 2xl:pb-4 xl:pb-4 lg:pb-4 md:w-[95%] md:pb-4 mb-3 pb-2">
                    Software Design + Architecture
                  </li>
                  <li className="text-[#e6e6e6] border-b border-[#2B2B2B] border-b-2 font-mono 2xl:text-[1.25rem] 2xl:leading-[1.563rem] text-[0.875rem] leading-[1.125rem] md:text-base lg:text-[1.125rem] lg:leading-[1.438rem] 2xl:w-[96%] xl:w-[90%] lg:w-[96%] md:w-[95%] sm:w-[85%] 2xl:pb-4 xl:pb-4 lg:pb-4 md:pb-4 mb-3 pb-2">
                    UX + UI Design
                  </li>
                  <li className="text-[#e6e6e6] border-b border-[#2B2B2B] border-b-2 font-mono 2xl:text-[1.25rem] 2xl:leading-[1.563rem] text-[0.875rem] leading-[1.125rem] md:text-base lg:text-[1.125rem] lg:leading-[1.438rem] 2xl:w-[96%] xl:w-[90%] lg:w-[96%] md:w-[95%] sm:w-[85%] 2xl:pb-4 xl:pb-4 lg:pb-4 md:pb-4 mb-3 pb-2">
                    Discovery and Needs Assessment
                  </li>
                  <li className="text-[#e6e6e6] border-b border-[#2B2B2B] border-b-2 font-mono 2xl:text-[1.25rem] 2xl:leading-[1.563rem] text-[0.875rem] leading-[1.125rem] md:text-base lg:text-[1.125rem] lg:leading-[1.438rem] 2xl:w-[96%] xl:w-[90%] lg:w-[96%] md:w-[95%] sm:w-[85%] 2xl:pb-4 xl:pb-4 lg:pb-4 md:pb-4 md:mb-0 lg:mb-0 pb-2">
              ...
              <div>
                <ul className="2xl:ml-4 2xl:pl-5 xl:pl-10 lg:pl-6 lg:ml-0 md:pl-5 ml-4">
                  <li className="text-[#e6e6e6] border-b border-[#2B2B2B] border-b-2 font-mono 2xl:pb-4 2xl:text-[1.25rem] 2xl:leading-[1.563rem] text-[0.875rem] leading-[1.125rem] md:text-base lg:text-[1.125rem] lg:leading-[1.438rem] lg:leading-[1.438rem] text-gray-300 lg:w-[95%] 2xl:w-[98%] xl:pb-4 lg:pb-4 md:pb-4 mb-3 pb-2">
                    Technical Solution Evaluation
                  </li>
                  <li className="text-[#e6e6e6] border-b border-[#2B2B2B] border-b-2 font-mono 2xl:pb-4 2xl:text-[1.25rem] 2xl:leading-[1.563rem] text-[0.875rem] leading-[1.125rem] md:text-base lg:text-[1.125rem] lg:leading-[1.438rem] lg:leading-[1.438rem] lg:w-[95%] 2xl:w-[98%] xl:pb-4 lg:pb-4 md:pb-4 mb-3 pb-2">
                    Development Process Consulting
                  </li>
                  <li className="text-[#e6e6e6] border-b border-[#2B2B2B] border-b-2 font-mono 2xl:pb-4 2xl:text-[1.25rem] 2xl:leading-[1.563rem] text-[0.875rem] leading-[1.125rem] md:text-base lg:text-[1.125rem] lg:leading-[1.438rem] lg:leading-[1.438rem] lg:w-[95%] 2xl:w-[98%] xl:pb-4 lg:pb-4 md:pb-4 mb-3 pb-2">
                    Team Mentoring
                  </li>
                  <li className="text-[#e6e6e6] border-b border-[#2B2B2B] border-b-2 font-mono 2xl:pb-4 2xl:text-[1.25rem] 2xl:leading-[1.563rem] text-[0.875rem] leading-[1.125rem] md:text-base lg:text-[1.125rem] lg:leading-[1.438rem] lg:leading-[1.438rem] lg:w-[95%] 2xl:w-[98%] xl:pb-4 lg:pb-4 md:pb-4 md:mb-0 lg:mb-0 pb-2">
      ...
      <div className="bg-black text-white px-6 py-10 md:py-16 lg-py-60 lg:px-28 xl:px-28 overflow-hidden">
        <div className="pt-16 sm:pt-16 md:pt-16 lg:pt-32 xl:pt-40  max-w-screen-2xl mx-auto">
          ...
          <div className="ml-[-21px] md:ml-0 mt-20 mb-8 center space-x-6 slick-slider flex">
            ...
            {/*  */}
            <div className="cursor-pointer group">
              <div className="relative group-hover:shadow-[0px_20px_40px_0px_rgba(159,90,253,0.1)] scale-100 group-hover:scale-105 duration-300">
                <img
              ...
              <div className="mt-4 sm:mt-10">
                <h5 className="lg:text-[30px] md:text[24px] sm:text-[20px] text-2xl mb-5 group-hover:text-[#65b722]">
                  Sweetwtaer Sound
                </h5>
                <p className="lg:text-[16px] md:text-[16px] sm::text-[16px] text-[16px] mb-4">
            ...
            {/*  */}
            <div className="cursor-pointer group">
              <div className="relative group-hover:shadow-[0px_20px_30px_0px_rgba(159,90,253,0.1)] scale-100 group-hover:scale-105 duration-300">
                <img
                  src="/slider-img/three.jpg"
                  className="w-full object-cover h-64"
                />
                <div className="absolute md:bottom-4 bottom-10 left-4 flex flex-wrap sm:hidden md:hidden lg:flex hidden">
                  <a
                    href="#"
                    className="bg-[#65b722] text-[12px] text-white uppercase px-4"
                  >
              ...
              <div className="mt-4 sm:mt-10">
                <h5 className="lg:text-[30px] md:text[24px] sm:text-[20px] text-2xl mb-5 group-hover:text-[#65b722] duration-300">
      ...
      <div className="container-fluid px-6 md:px-16 lg:px-28 bg-[#1A1A1A] text-white">
        <div className="container mx-auto py-36 md:py-40 lg:py-40 2xl:py-[11.80rem]">
          <h3 className="font-[signifier] font-[100] italic text-[2.25rem] leading-[2.813rem] lg:text-6xl lg:leading-[4.688rem] md:text-[3.75rem] md:leading-[4.688rem]">
            ...
            They're{" "}
            <br className="2xl:hidden xl:hidden lg:hidden md:hidden hidden" />
            calm under <br className="2xl:block hidden" />
            pressure.They're{" "}
            <br className="2xl:hidden xl:block lg:block hidden" />
            the{" "}
            <br className="2xl:hidden xl:hidden lg:hidden md:block hidden" />
            kind
