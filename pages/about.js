...
export default function About() {
  return (
    <>
      ...
      <div class="bg-black">
        ...
        <div class="container-fluid bg-black px-6 md:px-16 lg:px-28 2xl:px-0">
          <div
            class="container mx-auto bg-black sm:-mt-24 -m-20 sm:pt-36 pt-14 2xl:pb-[6.5rem] lg:pb-[5.5rem] md:pb-[3.375rem] sm:pb-[1.375rem] pb-[1.563rem] min-h-[490px] md:min-h-[877px]"
          >
          {/* <!-- Hero Section Start Here --> */}
            <div class="md:mt-[0px] box-border">
              <div
                class="main heading 2xl:mt-[8.5rem] lg:mt-[7.5rem] md:mt-[6.5rem] sm:mt-[3.1rem] mt-[7.5rem]"
              >
                <h1
                  class="font-[Signifier] xl:font-[300] 2xl:text-[20rem] 2xl:leading-[20rem] xl:text-[18rem] xl:font-[270] xl:leading-[17rem] lg:text-[14rem] lg:leading-[14rem] lg:font-[275] md:text-[12rem] md:leading-[12rem] md:font-[270] sm:text-[10rem] sm:leading-[10rem] sm:font-[270] text-[3.75rem] leading-[3.75rem] font-[230] text-white 2xl:mt-5 2xl:pb-0 xl:mt-36 lg:mt-0 xl:pb-2 lg:pb-0 lg:mb-8 md:mb-0 sm:mb-4 pb-8"
                >
                  About
                </h1>
              </div>
              <div
                class="font-[signifier] text-white font-[100] lg:text-4xl lg:leading-[3.125rem] md:text-[2.25rem] md:leading-[3.125rem] sm:text-[1.875rem] sm:leading-[2.563rem] text-[1.5rem] leading-[2.063rem] pt-0 pb-40"
              >
                <h3 class="mb-7">Yup, we develop software.</h3>
                <p
                  class="xl:pt-[0.106rem] lg:pt-[0.188rem] md:pt-[0.240rem] sm:pt-[0.195rem] lg:text-4xl lg:leading-[3.125rem] md:text-[2.25rem] md:leading-[3.125rem] sm:text-[1.875rem] sm:leading-[2.563rem] text-[1.5rem] leading-[2.063rem] leading-[2.063rem] pt-[3px]"
                >
      ...
      <div class="container-fluid px-6 md:px-16 lg:px-28 py-10 md:py-16 lg:py-24 relative bg-[#272727]">
        <div class="container mx-auto">
          <div class="max-w-screen-2xl mx-auto py-6 md:py-10">
            <div class="absolute top-0 right-0 z-0 w-1/4 origin-right scale-110 -translate-y-3 md:-translate-y-6">
              <svg aria-hidden="true" class="w-full h-full" viewBox="0 0 625 825">
                <g>
            ...
            <div class="relative z-10 pb-6 font-[signifier] text-5xl text-white md:text-7xl font-[100] sm:pb-12 lg:pb-24">
              <h3>Our core values</h3>
            </div>
            <div class="z-10 md:pl-8 md:pr-16 lg:pl-12 lg:pr-24 xl:pl-12 xl:pr-32 2xl:pl-28 2xl:pr-48">
              <div class="2xl:pr-28 pr-0">
                <div class="py-6 lg:py-8">
                  <h3 class="text-3xl lg:text-4xl text-[#65b722] font-[signifier] font-[100] pb-4 lg:pb-8">
                    <span class="hidden sm:inline font-[Pitch-Sans] word-spacing-tight font-semibold text-base text-gray-400 w-12">01</span>
                    We prioritize trust
                  </h3>
                  <p class="text-[#D1D1D1] md:pl-8 lg:pl-12 xl:pl-20 2xl:text-[1.125rem] 2xl:leading-[2.125rem] xl:text-[1.125rem] xl:leading-[2.125rem] lg:text-[1.125rem] lg:leading-[2.125rem] md:text-[1.125rem] md:leading-[2.125rem]">
              ...
              <div class="py-6 lg:py-8">
                <h3 class="text-3xl lg:text-4xl text-[#65b722] font-[signifier] font-[100] pb-4 lg:pb-8">
                  <span class="hidden sm:inline font-[Pitch-Sans] word-spacing-tight font-semibold text-base text-gray-400 w-12">02</span>
              ...
              <div class="py-6 lg:py-8">
                <h3 class="text-3xl lg:text-4xl text-[#65b722] font-[signifier] font-[100] pb-4 lg:pb-8">
                  <span class="hidden sm:inline font-[Pitch-Sans] word-spacing-tight font-semibold text-base text-gray-400 w-12">03</span>
              ...
              <div class="py-6 lg:py-8">
                <h3 class="text-3xl lg:text-4xl text-[#65b722] font-[signifier] font-[100] pb-4 lg:pb-8">
                  <span class="hidden sm:inline font-[Pitch-Sans] word-spacing-tight font-semibold text-base text-gray-400 w-12">04</span>
              ...
              <div class="py-6 lg:py-8">
                <h3 class="text-3xl lg:text-4xl text-[#65b722] font-[signifier] font-[100] pb-4 lg:pb-8">
                  <span class="hidden sm:inline font-[Pitch-Sans] word-spacing-tight font-semibold text-base text-gray-400 w-12">05</span>
              ...
              <div class="py-6 lg:py-8">
                <h3 class="text-3xl lg:text-4xl text-[#65b722] font-[signifier] font-[100] pb-4 lg:pb-8">
                  <span class="hidden sm:inline font-[Pitch-Sans] word-spacing-tight font-semibold text-base text-gray-400 w-12">06</span>
              ...
              <div class="py-6 lg:py-8">
                <h3 class="text-3xl lg:text-4xl text-[#65b722] font-[signifier] font-[100] pb-4 lg:pb-8">
                  <span class="hidden sm:inline font-[Pitch-Sans] word-spacing-tight font-semibold text-base text-gray-400 w-12">07</span>
              ...
              <div class="py-6 lg:py-8">
                <h3 class="text-3xl lg:text-4xl text-[#65b722] font-[signifier] font-[100] pb-4 lg:pb-8">
                  <span class="hidden sm:inline font-[Pitch Sans] word-spacing-tight font-semibold text-base text-gray-400 w-12">08</span>
    ...
    <div
      class="container-fluid bg-black text-white px-6 md:px-16 lg:px-28 py-10 md:py-16 lg:py-36"
    >
      <div class="container mx-auto">
        <div class="max-w-screen-2xl mx-auto">
          <h1
            class="w-full text-7xl md:text-8xl lg:text-[10rem] font-[signifier] font-[200] 2xl:mt-0 mt-10 mb-10 md:mb-16 lg:mb-20"
          >
            This is us.
          </h1>
          <div class="flex justify-end">
            <div
              class="font-[signifier] text-3xl lg:text-5xl xl:text-6xl 2xl:text-6xl font-[100] w-full md:w-3/4 lg:w-2/3"
            >
              <p>
              ...
              <div
                class="flex mt-12 space-x-6 md:space-x-10"
              >
                <div class="flex">
                  <a
                    href="/team"
                    class="font-mono 2xl:text-[1rem] 2xl:leading-[1.5rem] text-sm md:text-base text-white hover:bg-white hover:text-black duration-300 tracking-[0.125rem] font-bold tracking-widest rounded-full py-3 px-8 uppercase leading-none bg-[#65b722] box-border"
                  >
                    <span class="hidden sm:inline">Meet </span>Our Team
                  </a>
                </div>
                <div class="flex">
                  <a
                    href="/team"
                    class="font-mono text-sm md:text-base text-white hover:bg-white hover:text-black duration-300 tracking-[0.125rem] font-bold tracking-widest rounded-full py-3 px-4 uppercase leading-none bg-[#65b722] box-border"
                  >
                    <span class=" sm:inline">COLLOBARATE WITH US</span>
                  </a>
                </div>
              </div>
            </div>
    ...
    <div
      class="container-fluid px-6 md:px-16 lg:px-28 py-10 md:py-16 lg:py-24 bg-[#1A1A1A]"
    >
      <div class="container max-w-screen-2xl mx-auto">
        <div>
          <h1
            class="text-5xl md:text-7xl font-[signifier] font-[100] text-white mt-6 sm:mt-12 mb-12 sm:mb-16 md:mb-24"
          >
            Community initiatives
          </h1>
        </div>
        <div
          class="grid gap-12 sm:grid-cols-3 sm:gap-6 md:gap-8 lg:gap-12 xl:gap-16"
        >
          {/* <!-- Scholarships --> */}
          <div class="group cursor-pointer flex flex-col mb-8 text-white">
            <a
              href="https://laraconscholarship.com/"
              class="transition ease-in-out duration-300 group-hover:scale-105 group-hover:shadow-2xl group-hover:shadow-blue-500/20"
            >
              <div
                class="flex flex-col justify-end relative overflow-hidden aspect-w-1 aspect-h-1"
              >
                <img
                ...
                />
                <div
                  class="absolute top-auto bottom-0 left-0 right-0 h-2/3 opacity-40 bg-gradient-to-b from-transparent to-black"
                ></div>
                <div
                  class="absolute flex flex-col justify-end mx-1 p-5 sm:p-3 lg:p-5 xl:p-8 z-10"
                >
                  <p
                    class="font-[signifier] font-[300] text-white 2xl:text-[2.25rem] 2xl:leading-[2.813rem] text-4xl leading-tight sm:text-2xl sm:leading-tight xl:text-4xl xl:leading-tight"
                  >
                    Laracon <br class="2xl:hidden block" />
                    Scholarships
                  </p>
                </div>
              </div>
            ...
            <div class="text-charcoal-20 mt-4 md:mt-6 xl:mt-9 px-4">
              <a
                href="https://laraconscholarship.com/"
                class="block text-[#c0c0c0] font-[400] 2xl:text-[1.225rem] 2xl:leading-[2.125rem] xl:text-[1.063rem] xl:leading-[1.875]"
              >
          ...
          <div class="group cursor-pointer flex flex-col mb-8 text-white">
            <a
              href="https://laraconscholarship.com/"
              class="transition ease-in-out duration-300 group-hover:scale-105 group-hover:shadow-2xl group-hover:shadow-green-500/20"
            >
              <div
                class="flex flex-col justify-end overflow-hidden relative aspect-w-1 aspect-h-1"
              >
                <img
                ...
                ></div>
                <div
                  class="absolute flex flex-col justify-end mx-1 p-5 sm:p-3 lg:p-5 xl:p-8"
                >
                  <p
                    class="font-[signifier] font-[300] text-white 2xl:text-[2.25rem] 2xl:leading-[2.813rem] text-4xl leading-tight sm:text-2xl sm:leading-tight xl:text-4xl xl:leading-tight"
                  >
                    Apprenticeship <br class="2xl:hidden block" />
                    Program
                  </p>
                </div>
              </div>
          ...
          <div class="group cursor-pointer flex flex-col mb-8 text-white">
            <a
              href="https://laraconscholarship.com/"
              class="transition ease-in-out duration-300 group-hover:scale-105 group-hover:shadow-2xl group-hover:shadow-pink-500/20"
            >
              <div class="flex flex-col justify-end overflow-hidden relative">
                <img
    ...
    <div class="container-fulid bg-black -mt-74 text-white px-6 md:px-16 lg:px-28 py-10 md:py-16 lg:py-28 ">
      <div class="container mt-10 mx-auto">
        ...
        <div class="grid gap-12 sm:grid-cols-3 sm:gap-6 md:gap-8 lg:gap-12 xl:gap-16">
          ...
          <div class="group cursor-pointer flex-1 flex flex-col mb-8 text-white">         
            ...
            <div class="pt-6 font-serif font-light text-3xl leading-tight sm:text-2xl sm:leading-tight xl:text-4xl xl:leading-tight group-hover:text-[#65b722]">
                 <a href="#" aria-label="Twenty Percent Time Podcast" class="block">
                 Twenty Percent Time Podcast
                 </a>
            </div>

            <div class="text-charcoal-20 mt-4 md:mt-6 xl:mt-10 leading-loose sm:text-sm sm:leading-loose lg:text-base lg:leading-loose 2xl:text-lg 2xl:leading-loose px-0">
                 <a href="#" aria-label="Twenty Percent Time Podcast" class="block">
         ...
         <div class="group cursor-pointer flex-1 flex flex-col mb-8 text-white">        
           ...
           <a href="#" aria-label="Conference Talks" class="transition ease-in-out duration-300 group-hover:scale-105 group-hover:shadow-2xl  bg-neutral-800">
     
            <div class="flex flex-col justify-end overflow-hidden aspect-w-1 aspect-h-1 bg-charcoal" title="Conference Talks" subtext="Members of Team Tighten have given talks at nearly every Laracon in history." link="https://laracon.net/">
             
              <div class="flex items-center justify-center transition duration-300 sm:grayscale sm:group-hover:grayscale-0 h-[327px] sm:p-5 xl:p-10 2xl:p-16 sm:opacity-40 sm:group-hover:opacity-100">
                <svg fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 727.6 278.7" class="w-full h-full">
                  {/* svg is used here for image */}
             ...
             <div class="pt-6 font-serif font-light text-3xl leading-tight sm:text-2xl sm:leading-tight xl:text-4xl xl:leading-tight group-hover:text-[#65b722]">
                     <a href="https://laracon.net/" aria-label="Conference Talks" class="block">
                     Conference Talks
                     </a>
                 </div>
     
            <div class="text-charcoal-20 mt-4 md:mt-6 xl:mt-10 leading-loose sm:text-sm sm:leading-loose lg:text-base lg:leading-loose 2xl:text-lg 2xl:leading-loose px-0">
                     <a href="#" aria-label="Conference Talks" class="block">
     ...
     <div class="flex flex-col justify-end overflow-hidden aspect-w-1 aspect-h-1 bg-charcoal" title="The Laravel Podcast" subtext="We sponsor, and Matt hosts, the official podcast for all things Laravel." link="https://laravelpodcast.com/">
         ...
         <div class="pt-6 font-serif font-light text-3xl leading-tight sm:text-2xl sm:leading-tight xl:text-4xl xl:leading-tight group-hover:text-[#65b722]">
                 <a href="#" aria-label="The Laravel Podcast" class="block">
                 The Laravel Podcast
                 </a>
             </div>
